...
-   OD_Matrix: a distance matrix in csv format. There are six fields in the data file. They are:
    ...
    -   origin_id: the unique id values of the origin (i.e. fid of hexagon data set.), destination_id: the unique id values of the destination (i.e. fid of ELDERCARE data set.),
...
# 5.0 Aspatial Data Handling and Wrangling
...
## 7.2 Visualising KD2SFCA Accessibility
...
# 8.0 Modelling and Visualising Accessibility using spatial Accessiblity Measure (SAM) method
...
## 8.2 Visualising SAM Accessibility
