...
Install and launches R packages into R environment

```{r}
pacman::p_load(olsrr, corrplot, ggpubr, sf, spdep, GWmodel, tmap, tidyverse, gtsummary)
```

4.0 A short note about GWmodel
...
8.0 Hedonic Pricing Modelling in R
...
8.5 Preparing Publivation Quality Table: gtsummary method
...
9.0 Building Hedonic Pricing Model using GWMethod
...
9.4 Converting SFD onto sf data.frame
